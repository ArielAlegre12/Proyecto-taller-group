...
class UsuarioController extends Controller
{
    ...
    {
        $roles = Roll::all(); //necesario para el <selected> del formulario 
    ...
    {
        $request->validate([
            'nombre' => 'requiered|string|max:100',
            'email' => 'required|email|unique:usaurios',
        ...
        return redirect()->route('usaurios.index')->with('exito', 'Usuario registrado.');
    }
