        ...
        <div class="login-container">
            <div class="text-center mb-4">
                <div class="logo-circle mb-3">
                        <img src="{{ asset('images/logo.png') }}" alt="logo" class="logo-img-grande">
                    </div>
            ...
            <div class="card p-4 shadow">
                <div class="d-flex bg-light rounded p-1 mb-4">
                    <button class="btn btn-tab active w-50">Iniciar sesion</button>
                    <button class="btn btn-tab w-50">Registrarse</button>
                </div>
                <form>
                    <div class="mb-3 d-none">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-contro" placeholder="Juan Perez">
                        </div>
                    </div>
